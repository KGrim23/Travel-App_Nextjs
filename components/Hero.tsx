...
const Hero = () => {
  return (
    <section className="flex flex-col pt-8 p-8 max-container padding-container lg:gap-5 lg:pt-8">
      ...
      <p className="regular-16 text-center text-black pt-8">Get instant help from our friendly <span className="font-extrabold">Appie</span> AI assistant and connect with global mentors, tutors, and coaching experts!
      </p>
